...
bool Config::config_exist() {
    ...
    if(!fs::exists(ubi_translations)) {
        ...
        if(!Network::download_file("https://git.marco007.dev/marco/smdata/raw/branch/main/ubi_translations.json", ubi_translations)) {
    ...
    if(!fs::exists(steam_appids)) {
        ...
        if(!Network::download_file("https://git.marco007.dev/marco/smdata/raw/branch/main/steamids.json", steam_appids)) {
